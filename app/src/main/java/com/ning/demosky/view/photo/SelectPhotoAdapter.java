...
public class SelectPhotoAdapter extends ArrayAdapter<SelectPhotoAdapter.SelectPhotoEntity> implements OnClickListener{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {//第一个位置显示一个小相机
            ...
            viewHolder.iv_photo.setImageDrawable(getDrawable(mActivity,R.mipmap.cameraadd));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.rlPhoto:
                ...
                //bundle.putParcelable("SelectPhotoEntity",entity);
                bundle.putSerializable("SelectPhotoEntity",entity);
                intent.putExtra("EntityBundle",bundle);
...
//                    ivSelect.setImageDrawable(getDrawable(mActivity, R.mipmap.unchoose));
//                    removeSelectedPhoto(entity);
//
//                } else if (!isFullInSelectedPhotoArrayList()){
//                    ivSelect.setImageDrawable(getDrawable(mActivity, R.mipmap.choose));
